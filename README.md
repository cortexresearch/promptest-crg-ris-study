...
2. **Does a higher score predict a better real-world coding outcome?** → **Falsified, for this task.** Four prompts spanning all four tiers were given, verbatim, to independent coding agents against the identical underlying bug. All four produced a correct fix; the lowest-tier prompts actually took *fewer* turns than the "good"-tier prompt. The preregistered hypothesis did not hold, and is reported as falsified rather than reinterpreted.
